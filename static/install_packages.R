...
##   sprintf(fmt = "'%s'")
deps <- c('hca','celldex','MASS','SummarizedExperiment','TENxPBMCData','SingleCellExperiment','scater','SingleR','devtools','DT','LoomExperiment','scuttle','rols','ontoProc','shiny','vjcitn/csamaDist','Spectra','mzR','QFeatures','MsCoreUtils','scp','scpdata','MsDataHub','rpx','tidyverse','factoextra','msdata','rhdf5','impute','ProtGenerics','PSMatch','pheatmap','limma','RforMassSpectrometry/SpectraVis','OSCA.intro','OSCA.basic','OSCA.advanced','OSCA.multisample','OSCA.workflows','ade4','airway','Biobase','dplyr','factoextra','GGally','ggplot2','Hiiragi2013','pheatmap','phyloseq','RforMassSpectrometry/Spectra','RforMassSpectrometry/MsCoreUtils','MsExperiment','MetaboCoreUtils','MetaboAnnotation','png','sneumann/xcms','jorainer/SpectraTutorials','jorainer/MetaboAnnotationTutorials','jorainer/xcmsTutorials','DropletTestFiles','DropletUtils','EnsDb.Hsapiens.v86','scran','scDblFinder','scry','NewWave','GGally','igraph','mikelove/airway2','tximeta','DESeq2','org.Hs.eg.db','vsn','ExploreModelMatrix','apeglm','iSEE','iSEEu','edgeR','BiocStyle','knitr','rjson','AnnotationDbi','muscat','csoneson/ConfoundingExplorer','htmltools','rmarkdown','dplyr','ggplot2','tximport','airway','AnnotationHub','BiocCheck','BiocFileCache','BiocManager','BiocParallel','biocthis','biomaRt','Biostrings','BSgenome','BSgenome.Hsapiens.UCSC.hg19','BSgenome.Hsapiens.UCSC.hg38','ensembldb','ExperimentHub','GenomicAlignments','GenomicRanges','GenomicFeatures','Gviz','Homo.sapiens','HubPub','hugene20sttranscriptcluster.db','IRanges','KEGGREST','Organism.dplyr','readr','rtracklayer','Rsamtools','RNAseqData.HNRNPC.bam.chr14','tibble','tidyr','TxDb.Hsapiens.UCSC.hg19.knownGene','TxDb.Hsapiens.UCSC.hg38.knownGene','VariantAnnotation','randomNames','plyranges','GenomeInfoDb','nullranges','ggridges','plotgardener','oct4','org.Mm.eg.db','tidySummarizedExperiment','stringr','tidybulk','ggrepel','fission','purrr','glmnet')
